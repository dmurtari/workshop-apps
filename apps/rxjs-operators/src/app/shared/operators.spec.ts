...
fdescribe('Operators', () => {
    xit('takeEveryNth should take every nth object', () => {
        const results = [];
    ...
    xit('trimWhitespace trims leading and trailing whitespace', () => {
        const results = [];
    ...
    xit('getRandomCatFact should get a single cat fact', () => {
        const results = [];
    ...
    xit('makeItADog should make it a dog', () => {
